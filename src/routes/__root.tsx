...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Halat Yarışı" },
      { name: "description", content: "Sınıf için 2 takımlı Türkçe bilgi yarışması." },
      { property: "og:title", content: "Halat Yarışı" },
      { property: "og:description", content: "QR kod ile katıl, doğru cevapla halatı takımına çek." },
