...
INSERT INTO public.questions (question, option_a, option_b, option_c, option_d, correct_answer, category, difficulty, time_limit, set_id)
SELECT v.question, v.a, v.b, v.c, v.d, v.ans, v.cat, v.diff, 20, (SELECT id FROM public.question_sets ORDER BY created_at LIMIT 1)
FROM (VALUES
